 ...
 * @see html.tpl.php
 */
function seedpod_preprocess_html(&$variables) {
  // Add conditional stylesheets for IE
  $theme_path = drupal_get_path('theme', 'seedpod');
  ...
  drupal_add_css('https://fonts.googleapis.com/css?family=Alegreya|Averia+Sans+Libre|Josefin+Slab|Open+Sans|Open+Sans+Condensed:300|Righteous|Sansita|Special+Elite', array('group' => CSS_THEME));
 ...
 */
function seedpod_css_alter(&$css) {
  global $language;
 ...
 * Preprocess field.
 */
function seedpod_preprocess_field(&$variables) {
 ...
 */
function seedpod_preprocess_node(&$variables) {
